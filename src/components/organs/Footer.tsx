...
const Footer = () => {
  const renderIcon = useCallback((element: number) => {
    switch (element) {
      case 0:
        return <FaLocationArrow size={20} color="currentColor" />;
      case 1:
        return <MdMail size={20} color="currentColor" />;
      case 2:
        return <IoMdCall size={20} color="currentColor" />;
    }
  }, []);
      ...
      <main className="w-full lg:pt-28 lg:pb-12 pt-20 pb-12 px-6 grid md:grid-cols-3 lg:gap-8 md:gap-5 gap-8 lg:px-32">
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            >
              <IoBarbell size={35} color="currentColor" weight="fill" />
            </Text>
